    ...
    public partial class PrimeraMigracion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Eventos",
                columns: new[] { "idEvento", "DescripcionEvento", "IdUsuario", "NombreEvento", "diaEvento", "horaEvento" },
                values: new object[] { 1, "Un evento donde los estudiantes terminan clases, antes de descubrir si han aprobado o reprobado el semestre.", 0, "Fin Clases Semestre", new DateTime(2024, 1, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0) });
